        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-desktop"></i> <span>Gamificación</span></a>
            </div>
                            ...
                            <table>
                              ...
                              <div class="col-md-12">
                                <div class="box box-solid" style="background: #78E58F; border-color: #78E58F;">
                                  ...
                                  <div class="box-body">
                                    <!--Aquí van los inputs-->
                                    <input type="text" class="form-control" placeholder="Palabra" id="palabra">
                                  </div>
                                  <!-- /.box-body -->
                                </div>
                                <!-- /.box -->
                          ...
                          <table id="tablaCrucigrama">
                            ...
                            <div class="col-md-12">
                              <div class="box box-solid" style="background: #78E58F; border-color: #78E58F;">
                                ...
                                <div class="box-body">
                                  <!--Aquí van los inputs-->
                                  <input type="text" class="form-control" placeholder="Palabra" id="updateP">
                                </div>
                                <!-- /.box-body -->
                              </div>
                              <!-- /.box -->
